...
We understand, there are situations and occasions we may want to take off. In that case, the class should contact the instructor atleast 7 days in advance and request for a leave with the compensatory class declared well in advance after talking to all the students. Random requests for class cancellations will result in a _PP_ penalty.
